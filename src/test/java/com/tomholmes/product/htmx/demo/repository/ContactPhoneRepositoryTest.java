...
public class ContactPhoneRepositoryTest extends BaseRepositoryTests
{
    @Autowired
    ...
    public void testCreate() throws Exception
    {
        ...
        // =================================================================================
        System.out.println("testCreate: START");
        List<ContactPhoneEntity> contactPhones = contactPhoneRepository.findByContact(contact);
        ...
        // =================================================================================
        // contactPhoneRepository.deleteContactPhoneEntity(contactPhone);
    }
    ...
    public void testContactRetrieve()
    {
        ...
        List<ContactPhoneEntity> contactPhones = (List<ContactPhoneEntity>) contactPhoneRepository.findAll();
    ...
    public void testContactRetrieveById()
    {
        ...
        ContactPhoneEntity contactPhone = contactPhoneRepository.findById(null).orElse(null);
        ;
        assertNotNull(contactPhone.getPhoneId());
        // ************************************************************
        assertNotNull(contactPhone.getPhoneId());
    ...
    public void XtestContactDelete()
    {
        ...
        // ***************************************************************
        long id = 10;
        contactPhone = contactPhoneRepository.findById(null).orElse(null);
        contactPhoneRepository.delete(contactPhone);
        contactPhoneGet = contactPhoneRepository.findById(null).orElse(null);
    ...
    public void X_testContactPhoneEntityByName() {
        ...
        interest1 = contactPhoneRepository.saveContactPhoneEntity(interest1);
        ...
        interest2 = contactPhoneRepository.saveContactPhoneEntity(interest2);
        ...
        interest3 = contactPhoneRepository.saveContactPhoneEntity(interest3);
        assertNotNull(interest2);
        // =================================================================================
        String interestName = "TEST";
        List<ContactPhoneEntity> interests = contactPhoneRepository.getContactPhoneEntitysByName(interestName);
        ...
        contactPhoneRepository.deleteContactPhoneEntity(interest1);
        contactPhoneRepository.deleteContactPhoneEntity(interest2);
        contactPhoneRepository.deleteContactPhoneEntity(interest3);
