...
public class PhoneTypeRepositoryTest extends BaseRepositoryTests
{
    @Autowired
    ...
    public void testPhoneTypeDelete()
    {
        ...
        // =================================================================================
        long phoneTypeId = 4;
        PhoneTypeEntity phoneType = phoneTypeRepository.findById(phoneTypeId).orElse(null);
        phoneTypeRepository.delete(phoneType);

        PhoneTypeEntity phoneTypeGet = phoneTypeRepository.findById(phoneTypeId).orElse(null);
    ...
    public void X_testPhoneTypeEntityByName() {
        ...
        interest1 = phoneTypeRepository.savePhoneTypeEntity(interest1);
        ...
        interest2 = phoneTypeRepository.savePhoneTypeEntity(interest2);
        ...
        interest3 = phoneTypeRepository.savePhoneTypeEntity(interest3);
        assertNotNull(interest2);
        // =================================================================================
        String interestName = "TEST";
        List<PhoneTypeEntity> interests = phoneTypeRepository.getPhoneTypeEntitysByName(interestName);
        ...
        phoneTypeRepository.deletePhoneTypeEntity(interest1);
        phoneTypeRepository.deletePhoneTypeEntity(interest2);
        phoneTypeRepository.deletePhoneTypeEntity(interest3);
